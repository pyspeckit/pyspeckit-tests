...
sp2.smooth(4)
sp2.plotter()
amp,cen,wid = pyspeckit.moments.moments(sp2.xarr, sp2.data, vheight=False)
sp2.specfit(guesses=[amp,cen,wid])
...
sp3.smooth(4)
sp3.plotter()
amp,cen,wid = pyspeckit.moments.moments(sp3.xarr, sp3.data, vheight=False)
sp3.specfit(guesses=[amp,cen,wid])
...
sp.specfit(guesses=[amp,cen,wid])
...
sp.specfit(fittype='ammonia',  guesses=[21.57, 5.0, 14.469, 1.11,
...
sp3.plotter()
sp3.baseline()
sp3.specfit(fittype='ammonia',  guesses=[145.0, 135.0, 14.74, 1.752,
...
sp3.specfit(fittype='ammonia',  guesses=sp3.specfit.modelpars,
